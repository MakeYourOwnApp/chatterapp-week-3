...
### Solution Week 3 (Starter Pack for Week 4)
...
```bash
git clone https://github.com/TUMxInteractionProgramming/chatterapp-week-4-YOURGITHUBNAME
```
...
```url
https://github.com/TUMxInteractionProgramming/chatterapp-week-4-YOURGITHUBNAME
```
